...
def main():
    ...
    if args.dataset == "blink":
        gt_file = "/home/debarpanb/VLM_project/apoorva_works/Speech_LLM/VLM_entropy/blink_data/answer_list.txt"
    elif args.dataset == "vsr":
        gt_file = "/home/debarpanb/VLM_project/apoorva_works/Speech_LLM/VLM_entropy/vsr_data/answers_subset.txt"
    else:
