...
def main():
    parser = argparse.ArgumentParser(description='Qwen perturb predictions for LALM')
    ...
    # Set output filename
    if exp_type == "orig":
        output_file = f"{output_dir}/qwen_{task}_perturb.txt"
    else:
        output_file = f"{output_dir}/negated_qwen_{task}_perturb.txt"
