...
def main():
    parser = argparse.ArgumentParser(description='Desc LLM vanilla predictions for LALM')
    ...
    # Set output filename
    if exp_type == "orig":
        output_file = f"{output_dir}/desc_llm_{task}_vanilla.txt"
    else:
        output_file = f"{output_dir}/negated_desc_llm_{task}_vanilla.txt"
