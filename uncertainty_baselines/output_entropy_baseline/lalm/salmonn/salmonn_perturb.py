...
def main():
    parser = argparse.ArgumentParser(description='SALMONN perturb predictions for LALM')
    ...
    # Set output filename
    if exp_type == "orig":
        output_file = f"{output_dir}/salmonn_{task}_perturb.txt"
    else:
        output_file = f"{output_dir}/negated_salmonn_{task}_perturb.txt"
