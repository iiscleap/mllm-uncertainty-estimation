...
def main():
    parser = argparse.ArgumentParser(description='Run Gemma3 verbalized confidence on spatial reasoning datasets')
    ...
    # Set output path
    output_path = os.path.join(args.output_dir, f"gemma3_guess_prob_{args.dataset.lower()}.csv")
