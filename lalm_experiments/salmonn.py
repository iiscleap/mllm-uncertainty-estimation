...
class SALMONN(nn.Module):
    ...
    def generate_calibration(self, samples, generate_cfg, prompts=None):
        batch_size = samples["spectrogram"].shape[0]
        ...
        text = self.llama_tokenizer.batch_decode(sequences, skip_special_tokens=True)
        ...
        top_tokens = self.llama_tokenizer.batch_decode([[tid] for tid in top_ids], skip_special_tokens=True)
