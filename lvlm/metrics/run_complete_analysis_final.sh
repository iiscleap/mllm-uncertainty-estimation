...
# Complete analysis script for LVLM experiments
# This script runs comprehensive metrics, generates all plots, and saves results as CSV
# All results will be saved in /home/debarpanb/VLM_project/malay_works/FESTA-uncertainty-estimation/results/lvlm

RESULTS_DIR="/home/debarpanb/VLM_project/malay_works/FESTA-uncertainty-estimation/results/lvlm"

echo "======================================================================="
echo "COMPLETE ANALYSIS FOR LVLM UNCERTAINTY ESTIMATION"
echo "======================================================================="
echo ""
...
if [ ! -d "vanilla_output" ]; then
    echo "Error: vanilla_output directory not found!"
    exit 1
fi

if [ ! -d "perturb_sampling_output" ]; then
    echo "Error: perturb_sampling_output directory not found!"
    exit 1
fi

if [ ! -f "answer_list.txt" ]; then
    echo "Error: answer_list.txt file not found!"
    exit 1
fi
