...
# FESTA LVLM Experiments - Gemma3 All Tasks Runner
# This script runs all Gemma3 experiments for both BLINK and VSR datasets
...
function run_auc_calculation() {
    local dataset="$1"
    local csv_file="$2"
    local output_file="gemma3_festa_auc_scores.txt"
    ...
    python kl_div_fusion.py --dataset "$dataset" --model gemma3 | tee -a "$output_file"
    echo "" | tee -a "$output_file"
...
echo "========================================="
echo "FESTA LVLM Experiments - Gemma3 Runner"
echo "========================================="
echo "Start Time: $(date '+%Y-%m-%d %H:%M:%S')"
echo ""

# Activate gemma3 conda environment
...
echo "Starting Gemma3 experiments..."
echo ""
...
echo "All Gemma3 experiments completed!"
echo ""
...
echo "==========================================" >> gemma3_festa_auc_scores.txt
echo "Summary completed on: $(date '+%Y-%m-%d %H:%M:%S')" >> gemma3_festa_auc_scores.txt
echo "All datasets processed: ${datasets[*]}" >> gemma3_festa_auc_scores.txt
echo "==========================================" >> gemma3_festa_auc_scores.txt

echo "========================================="
echo "FESTA LVLM Experiments - Gemma3 Complete!"
echo "End Time: $(date '+%Y-%m-%d %H:%M:%S')"
echo ""
echo "Results saved in:"
echo "   - vanilla_output/"
echo "   - perturb_sampling_output/"
echo "   - gemma3_festa_auc_scores.txt (AUC scores)"
echo "========================================="